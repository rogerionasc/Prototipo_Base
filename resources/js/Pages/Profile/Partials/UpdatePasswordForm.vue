...
<template>
    ...
    <FormSection @submitted="updatePassword" title="Alterar senha" description="Garanta que sua conta esteja usando uma senha longa e aleatória para permanecer segura.">
        <template #form>
            <div class="mb-3">
