            ...
            <BTab title="Dados Pessoais">
                <div class="row g-3 mt-2">
                    <div class="col-md-6">
                        ...
                        <input v-model="form.nome" type="text" class="form-control" id="nome" placeholder="Nome completo" required>
                    ...
                    <div class="col-md-3">
                        ...
                        <span class="text-danger ms-1">*</span>
                        <input v-model="form.cpf" v-mask="'###.###.###-##'" type="text" class="form-control" :class="{ 'is-invalid': form.errors.cpf }" id="cpf" placeholder="000.000.000-00" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-3">
                        ...
                        <input v-model="form.rg" v-mask="'###.###.###'" type="text" class="form-control" id="rg" placeholder="000.000.000">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <flatPickr v-model="form.data_nascimento" id="dataNascimento" class="form-control" :config="flatpickrOptions"
                            placeholder="Selecione a data" />
                    </div>
                    <div class="col-md-3">
                        <label for="naturalidade" class="form-label">Naturalidade</label>
                        <input v-model="form.naturalidade" type="text" class="form-control" id="naturalidade" placeholder="Cidade/UF">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-2">
                        ...
                        <input v-model.number="form.altura" type="number" step="0.01" class="form-control" id="altura" placeholder="1.75">
                    </div>
                    <div class="col-md-2">
                        <label for="peso" class="form-label">Peso (kg)</label>
                        <input v-model.number="form.peso" type="number" step="0.1" class="form-control" id="peso" placeholder="70.5">
                    </div>
                    <div class="col-md-2">
                        <label for="corPele" class="form-label">Cor da Pele</label>
                        <input v-model="form.cor_pele" type="text" class="form-control" id="corPele" placeholder="Cor da pele">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input v-model="form.telefone" v-mask="'(##) ##### ####'" type="text" class="form-control" id="telefone" placeholder="(00) 0000-0000">
                    </div>
                    <div class="col-md-6">
                        <label for="email" class="form-label">E-mail</label>
                        <input v-model="form.email" type="email" class="form-control" id="email" placeholder="email@dominio.com">
                    </div>
                    <div class="col-md-3">
                        <label for="celular" class="form-label">Celular</label>
                        <input v-model="form.celular" v-mask="'(##) #####-####'" type="text" class="form-control" id="celular" placeholder="(00) 00000-0000">
                    </div>
                    <div class="col-md-3">
                        <label for="profissao" class="form-label">Profissão</label>
                        <input v-model="form.profissao" type="text" class="form-control" id="profissao" placeholder="Profissão">
                    </div>
                    <div class="col-md-3">
                        <label for="escolaridade" class="form-label">Escolaridade</label>
                        <input v-model="form.escolaridade" type="text" class="form-control" id="escolaridade" placeholder="Escolaridade">
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-check">
                            <input v-model="form.receber_avisos" class="form-check-input" type="checkbox" id="receberAvisos">
                            <label class="form-check-label" for="receberAvisos">Sim</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <label for="nomeMae" class="form-label">Nome da Mãe</label>
                        <input v-model="form.nome_mae" type="text" class="form-control" id="nomeMae" placeholder="Nome da mãe">
                    </div>
                    <div class="col-md-6">
                        <label for="nomePai" class="form-label">Nome do Pai</label>
                        <input v-model="form.nome_pai" type="text" class="form-control" id="nomePai" placeholder="Nome do pai">
                    </div>
            ...
            <BTab title="Endereço">
                <div class="row g-3 mt-2">
                    ...
                    <div class="col-md-6">
                        ...
                        <input v-model="form.endereco" type="text" class="form-control" id="endereco" placeholder="Rua, Avenida, Travessa">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input v-model="form.complemento" type="text" class="form-control" id="complemento" placeholder="Apartamento, Bloco, etc.">
                    </div>
                </div>
            </BTab>
        </BTabs>
