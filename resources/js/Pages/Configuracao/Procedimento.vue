      ...
      <BCard class="shadow-sm border-0">
        ...
        <BCardBody>
          ...
          <div class="border border-dashed rounded p-3 bg-light-subtle mb-3">
            <BRow class="g-3">
              <BCol md="6">
                ...
                <input placeholder="Ex: Consulta Geral" v-model="formCreate.nome" type="text" id="procNome"
                  class="form-control" :class="{ 'is-invalid': formCreate.errors.nome }" maxlength="120" />
                <div class="invalid-feedback">{{ formCreate.errors.nome }}</div>
              </BCol>
              <BCol md="6">
                <label for="procCategoria" class="form-label">Categoria</label>
                <select data-choices v-model="formCreate.categoria_id" id="procCategoria" class="form-select"
                  :class="{ 'is-invalid': formCreate.errors.categoria_id }">
            ...
            <BRow class="g-3 mt-0 align-items-end">
              <BCol md="2">
                ...
                <select data-choices v-model="formCreate.eh_tratamento" id="procEhTrat" class="form-select"
                  :class="{ 'is-invalid': formCreate.errors.eh_tratamento }">
              ...
              <BCol md="2" v-if="formCreate.eh_tratamento">
                ...
                <input v-model="formCreate.quantidade_sessoes" type="number" min="1" id="procQSess" class="form-control"
                  :class="{ 'is-invalid': formCreate.errors.quantidade_sessoes }" />
              ...
              <BCol :md="formCreate.eh_tratamento ? 3 : 5">
                ...
                <input placeholder="Ex: 100.00" v-model="formCreate.valor" type="number" step="0.01" min="0"
                  id="procValorBase" class="form-control" :class="{ 'is-invalid': formCreate.errors.valor }" />
                <div class="invalid-feedback">{{ formCreate.errors.valor }}</div>
              </BCol>
              <BCol md="3">
                <label for="procComissao" class="form-label">Comissão (%)</label>
                <input placeholder="Ex: 10.00" v-model="formCreate.comissao_percentual" type="number" step="0.01"
                  min="0" max="100" id="procComissao" class="form-control"
                  :class="{ 'is-invalid': formCreate.errors.comissao_percentual }" />
              ...
              <BCol md="2">
                <button type="button" class="btn btn-primary w-100" :disabled="formCreate.processing"
                  @click="saveProcedimento">Adicionar</button>
              </BCol>
            </BRow>
          </div>
          <TableGrid :columns="columns" :data="tableData" :tableTitle="'Lista de Procedimentos'" :showTitle="false"
            ...
            :showStatus="true" :showPerPagination="true" :showAddButton="false" @delete="askDelete"
            @edit="startEditById" @show="openShow" />

          <Modal v-model="editModal" :title="'Editar Procedimento'" size="lg" :name-button="'Salvar'"
            :processing="formEdit.processing" @save="updateProcedimento">
            <BRow class="g-3">
              <BCol md="6">
