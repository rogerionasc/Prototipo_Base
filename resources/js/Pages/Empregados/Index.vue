...
const tableData = computed(() => {
  return (profissionaisLocal.value || []).map(p => {
    ...
    return { id: p.id, nome: p.nome, cargo: p.cargo || '-', contato: contato || '-' };
  });
});
...
const FORM_FIELDS = [
  "nome", "cpf", "rg", "sexo", "data_nascimento", "naturalidade", "estado_civil_id", "cargo", "cep", "endereco", "numero", "bairro", "cidade", "complemento", "email", "telefone", "celular", "observacoes"
];
...
<template>
  <Layout>
    ...
    <Head title="Pessoas" />
    <PageHeader title="Pessoas" pageTitle="Menu" />
    <TableGrid :columns="columns" :data="tableData" :tableTitle="'Lista de Empregados'" :search="true"
          ...
          <BTab title="Dados Pessoais">
            <div class="row g-3 mt-2">
              <div class="col-md-6">
                ...
                <input v-model="formCreate.nome" type="text" id="psNome" class="form-control"
                  :class="{ 'is-invalid': formCreate.errors.nome }" placeholder="Nome completo" required
                  maxlength="120" />
              ...
              <div class="col-md-3">
                ...
                <input v-model="formCreate.rg" v-mask="'###.###.###'" type="text" id="psRg" class="form-control"
                  placeholder="000.000.000" maxlength="11" />
              </div>
              <div class="col-md-3">
                <label for="psSexo" class="form-label">Sexo</label>
                <select v-model="formCreate.sexo" data-choices class="form-select mb-0" id="psSexo"
                  ref="sexoSelectCreate">
              ...
              <div class="col-md-3">
                ...
                <flatPickr v-model="formCreate.data_nascimento" id="psNascimento" class="form-control"
                  :config="flatpickrOptions" placeholder="Selecione a data" />
              </div>
              <div class="col-md-3">
                <label for="psNaturalidade" class="form-label">Naturalidade</label>
                <input v-model="formCreate.naturalidade" type="text" id="psNaturalidade" class="form-control"
                  placeholder="Brasileira" maxlength="60" />
              </div>
              <div class="col-md-3">
                <label for="psEstadoCivil" class="form-label">Estado Civil</label>
                <select v-model="formCreate.estado_civil_id" class="form-select mb-0" id="psEstadoCivil" data-choices
                  ref="estadoCivilSelectCreate">
              ...
              <div class="col-md-6">
                ...
                <input v-model="formCreate.email" type="email" id="psEmail" class="form-control"
                  placeholder="email@dominio.com" maxlength="100" />
              </div>
              <div class="col-md-6">
                <label for="psTelefone" class="form-label">Telefone</label>
                <input v-model="formCreate.telefone" v-mask="'(##) ##### ####'" type="text" id="psTelefone"
                  class="form-control" placeholder="(00) 0000-0000" maxlength="15" />
              </div>
              <div class="col-md-6">
                <label for="psCelular" class="form-label">Celular</label>
                <input v-model="formCreate.celular" v-mask="'(##) #####-####'" type="text" id="psCelular"
          ...
          <BTab title="Endereço">
            <div class="row g-3 mt-2">
              <div class="col-md-3">
                ...
                <input v-model="formCreate.cep" type="text" id="psCep" class="form-control" placeholder="00000-000"
                  maxlength="9" />
              </div>
              <div class="col-md-6">
                <label for="psEnderecoText" class="form-label">Endereço</label>
                <input v-model="formCreate.endereco" type="text" id="psEnderecoText" class="form-control"
                  placeholder="Rua, Avenida, Travessa" maxlength="120" />
              </div>
              <div class="col-md-3">
                <label for="psNumero" class="form-label">Número</label>
                <input v-model="formCreate.numero" type="text" id="psNumero" class="form-control" placeholder="Número"
                  maxlength="10" />
              </div>
              <div class="col-md-4">
                <label for="psBairro" class="form-label">Bairro</label>
                <input v-model="formCreate.bairro" type="text" id="psBairro" class="form-control" placeholder="Bairro"
                  maxlength="60" />
              </div>
              <div class="col-md-4">
                <label for="psCidade" class="form-label">Cidade</label>
                <input v-model="formCreate.cidade" type="text" id="psCidade" class="form-control" placeholder="Cidade"
                  maxlength="60" />
              </div>
              <div class="col-md-4">
                <label for="psComplemento" class="form-label">Complemento</label>
                <input v-model="formCreate.complemento" type="text" id="psComplemento" class="form-control"
          ...
          <BTab title="Dados Pessoais">
            <div class="row g-3 mt-2">
              <div class="col-md-6">
                ...
                <span class="text-danger ms-1">*</span>
                <input v-model="formEdit.nome" type="text" id="psEditNome" class="form-control"
                  :class="{ 'is-invalid': formEdit.errors.nome }" placeholder="Nome completo" required
                  maxlength="120" />
              ...
              <div class="col-md-3">
                ...
                <input v-model="formEdit.rg" v-mask="'###.###.###'" type="text" id="psEditRg" class="form-control"
                  placeholder="000.000.000" maxlength="11" />
              </div>
              <div class="col-md-3">
                <label for="psEditSexo" class="form-label">Sexo</label>
                <select v-model="formEdit.sexo" data-choices class="form-select mb-0" id="psEditSexo"
                  ref="sexoSelectEdit">
                  <option selected disabled value="">Selecione...</option>
                  <option v-for="s in sexoOptions" :key="s.value" :value="s.value">{{ s.label }}</option>
                </select>
              ...
              <div class="col-md-3">
                ...
                <flatPickr v-model="formEdit.data_nascimento" id="psEditNascimento" class="form-control"
                  :config="flatpickrOptions" placeholder="Selecione a data" />
              </div>
              <div class="col-md-3">
                <label for="psEditNaturalidade" class="form-label">Naturalidade</label>
                <input v-model="formEdit.naturalidade" type="text" id="psEditNaturalidade" class="form-control"
                  placeholder="Brasileira" maxlength="60" />
              </div>
              <div class="col-md-3">
                <label for="psEditEstadoCivil" class="form-label">Estado Civil</label>
                <select v-model="formEdit.estado_civil_id" class="form-select mb-0" id="psEditEstadoCivil" data-choices
                  ref="estadoCivilSelectEdit">
                  <option selected disabled :value="null">Selecione...</option>
                  <option v-for="e in props.estadosCivis" :key="e.id" :value="e.id">{{ e.descricao }}</option>
                </select>
              </div>
              ...
              <div class="col-md-6">
                ...
                <input v-model="formEdit.email" type="email" id="psEditEmail" class="form-control"
                  placeholder="email@dominio.com" maxlength="100" />
              </div>
              <div class="col-md-6">
                <label for="psEditTelefone" class="form-label">Telefone</label>
                <input v-model="formEdit.telefone" v-mask="'(##) ##### ####'" type="text" id="psEditTelefone"
                  class="form-control" placeholder="(00) 0000-0000" maxlength="15" />
              </div>
              <div class="col-md-6">
                <label for="psEditCelular" class="form-label">Celular</label>
                <input v-model="formEdit.celular" v-mask="'(##) #####-####'" type="text" id="psEditCelular"
                  class="form-control" placeholder="(00) 00000-0000" maxlength="15" />
              </div>
          ...
          <BTab title="Endereço">
            <div class="row g-3 mt-2">
              <div class="col-md-3">
                ...
                <input v-model="formEdit.cep" type="text" id="psEditCep" class="form-control" placeholder="00000-000"
                  maxlength="9" />
              </div>
              <div class="col-md-6">
                <label for="psEditEnderecoText" class="form-label">Endereço</label>
                <input v-model="formEdit.endereco" type="text" id="psEditEnderecoText" class="form-control"
                  placeholder="Rua, Avenida, Travessa" maxlength="120" />
              </div>
              <div class="col-md-3">
                <label for="psEditNumero" class="form-label">Número</label>
                <input v-model="formEdit.numero" type="text" id="psEditNumero" class="form-control" placeholder="Número"
                  maxlength="10" />
              </div>
              <div class="col-md-4">
                <label for="psEditBairro" class="form-label">Bairro</label>
                <input v-model="formEdit.bairro" type="text" id="psEditBairro" class="form-control" placeholder="Bairro"
                  maxlength="60" />
              </div>
              <div class="col-md-4">
                <label for="psEditCidade" class="form-label">Cidade</label>
                <input v-model="formEdit.cidade" type="text" id="psEditCidade" class="form-control" placeholder="Cidade"
                  maxlength="60" />
              </div>
              <div class="col-md-4">
                <label for="psEditComplemento" class="form-label">Complemento</label>
                <input v-model="formEdit.complemento" type="text" id="psEditComplemento" class="form-control"
                  placeholder="Apartamento, Bloco, etc." maxlength="60" />
              </div>
            </div>
          </BTab>
