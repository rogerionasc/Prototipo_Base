        ...
        <div class="d-flex">
          ...
          <div class="navbar-brand-box horizontal-logo">
            <Link href="/" class="logo logo-dark">
              <span class="logo-sm">
                <img src="/storage/logo-sistema/Logo-Top.svg" alt="" height="40" />
              </span>
              <span class="logo-lg">
                <img src="/storage/logo-sistema/Logo-Bottom.svg" alt="" height="80" style="margin: 0 auto; display: block;" />
              </span>
            </Link>

            <Link href="/" class="logo logo-light">
              <span class="logo-sm">
                <img src="/storage/logo-sistema/Logo-Top.svg" alt="" height="40" style="filter: brightness(0) invert(1);" />
              </span>
              <span class="logo-lg">
                <img src="/storage/logo-sistema/Logo-Bottom.svg" alt="" height="80" style="filter: brightness(0) invert(1); margin: 0 auto; display: block;" />
              </span>
            </Link>
          </div>
