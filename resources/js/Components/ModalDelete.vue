<template>
    ...
    <Teleport to="body">
        <div id="myModal" class="modal zoomIn" :class="[showClass]" tabindex="9999" aria-labelledby="myModalLabel"
            aria-hidden="true" :style="{ display: modelValue ? 'block' : 'none', zIndex: zIndex }">
            ...
            <div class="modal-dialog modal-dialog-centered modal-md" ref="modalDialog" :style="{ zIndex: zIndex + 10 }">
